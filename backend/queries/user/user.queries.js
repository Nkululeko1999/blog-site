...
export const saveUser = 'INSERT INTO users (username, email, password, user_role, profile_pic, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, CURRENT_TIMESTAMP, $6) RETURNING *';
